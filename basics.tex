...
\begin{thm}[Mapping Space]
    ...
    By \cite[116]{cisinski_2019} this space is a Kan-complex.
\end{thm}
...
\begin{definition}[Adjoint]
    ...
    Then we say that \emph{$F$ is left adjoint to $G$} or alternatively, that \emph{$G$ is right adjoint to $F$}
...
\begin{prop}[Existence of Pointwise Kan-Extensions]\label{prop:exKanExt}
    ...
    \begin{reference}
        ...
        The full faithfulness is implied by \cite[Corollary 7.3.1.16]{kerodon} where it is shown that counit/unit of the adjunction is an equivalence. 
    \end{reference}
\end{prop}
