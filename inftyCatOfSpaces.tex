...
\begin{prop}[Quillen Equivalence of the Quillen Model Structures on $\Top$ and $\sSet$]\label{prop:quillenEqSSetTop}
    ...
    \begin{proof}
        ...
        Thus $\lvert-\rvert\colon\sSet\to\Top$ preserves colimits and since $\lvert\partial\Delta^n\rvert\to\lvert\Delta^n\rvert\;\cong\;S^{n-1}\xhookrightarrow{} D^n$, geometric realization preserves cofibrations. %TODO can we just use that mono give inc of cw after |-|?
