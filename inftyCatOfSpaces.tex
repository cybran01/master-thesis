...
\end{thm}
\begin{remark}
    Since every h-fibration is also a fibration in the Quillen model structure and every homotopy equivalence is a weak equivalence, every cofibration of the Quillen model structure is an h-cofibration. %TODO maybe add that these classes do not agree
\end{remark}
...
\begin{thm}[Quillen Equivalence of Quillen Model Structures]\label{prop:quillenEqSSetTop}
    ...
    \begin{proof}
        ...
        This however follows from the fact that unit and counit of the adjunction are objectwise weak equivalences:
