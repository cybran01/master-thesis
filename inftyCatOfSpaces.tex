...
\begin{definition}[Hurewicz Cofibration]
    ...
    \begin{center}
        \begin{tikzcd} [sep = 1.5em]
            A \arrow[r,"\id_A\times\set{0}"] \arrow[d, "i"'] &[2.5em] A\times I \arrow[d, "i\times\id_I"] \arrow[ddr, bend left, "\overline{H}"] & \\[2.5em]
            B \arrow[r,"\id_B\times\set{0}"] \arrow[drr, bend right, "f"'] & B\times I \arrow[dr, dashed, "\exists H"] & \\
            && X
        \end{tikzcd}
    \end{center}
