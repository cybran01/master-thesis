...
\begin{prop}[Quillen Model Structure on $\Top$]
    ...
    \begin{itemize}
        ...
        \item Fibrations are the maps with right lifting property against the class of maps $\set{D^n\xhookrightarrow{\left(\id_{D^n},0\right)}D^n\times I\mid n\in\Nat}$ which are called \emph{Serre fibrations}.
    \end{itemize}
...
\begin{prop}[\Strom/ Model Structure on $\Top$]
    ...
    \begin{itemize}
        ...
        \item Fibrations are the maps with right lifting property against the class of maps $\set{X\xhookrightarrow{\left(\id_{X},0\right)}X\times I\mid X\in\Top}$ which are called \emph{Hurewicz fibrations}.
    \end{itemize}
