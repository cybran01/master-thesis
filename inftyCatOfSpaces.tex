...
\begin{thm}[Quillen Model Structure on $\Top$]
    ...
    The cofibrations are the smallest saturated class containing the maps $S^{n-1}\xhookrightarrow{}D^n$ for $n\in\Nat$ (where $S^{-1}=\emptyset$). %TODO confirm; add statement about small object argument
    \begin{reference}
