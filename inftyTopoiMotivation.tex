...
To motivate universal colimits, let $X\xtwoheadrightarrow{} B$ be a fibration, $X_1,X_2\subset X$ be a ``sufficiently good'' cover and let $X_0=X_1\cap X_2$, so that we have a homotopy pushout square
\begin{center}
...
\begin{center}
    \begin{tikzcd} [sep = .5 cm]
        ...
        & X_2 \arrow [rr, crossing over, >->] \arrow [dd] & &[-1em] X_1\cup_{X_{0}}X_2 \arrow [dd] & \\
        B_{0} \arrow [dr, >->] \arrow [rr, >->] & & B_1 \arrow [dr, >->] \\
        & B_2 \arrow [from=uu, crossing over] \arrow [rr, >->] & &[-1em] B_1\cup_{B_{0}}B_2 &
    \end{tikzcd}
\end{center}
