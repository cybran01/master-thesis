...
\begin{remark}
    ...
    It is deloopable if and only if there exists a group object $U\colon\N\left(\Delta^{\op}\right)\to\spaces$ where $U_n= X\times\ldots\times X$ with $X$ appearing $n$ times. %TODO is this true or does it need additional hypothesis (like certain maps being projections, etc)?
