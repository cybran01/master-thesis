...
\end{definition}
\begin{remark}
    Since terminal objects are essentially unique, choosing different terminal objects induces equivalent model of \inftycats/ of pointed objects.
\end{remark}
\begin{definition}
...
\begin{remark}
    ...
    It follows from \cref{prop:conn} \ref{prop:connSection} that the notion of a connected pointed space $*\to X$ here means that the space $X$ is $0$-connected in the language of \cref{def:connected}.
\end{remark}
