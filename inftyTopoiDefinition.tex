...
\begin{definition}[Cartesian Transformation]
    ...
    \begin{center}
        ...
        \end{tikzcd}
    \end{center}
    represented by the map $\Delta^1\times\Delta^1\xrightarrow{\left(u,\id_{\Delta^1}\right)}K\times\Delta^1\xrightarrow{\alpha}C$ is a pullback square. 
\end{definition}
...
\begin{lemma}\label{lem:univColimIffUnivPoAndCoprod}
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tikzpicture}\;.
        \end{center}
        Then $\alpha$ induces maps $\alpha_i\colon p_i\to q_i$ which are cartesian by the pasting law. %TODO how? (where does map to cone come from?)
        ...
        We can compute colimits of any diagram indexed by $K$ by computing the colimit of the diagram $\N(\Nat)\to C$ that for each $0$-simplex $n\in\Nat$ is the colimit of $K^n\to C$ and all higher simplicies are given by chains of the canonical maps. 
        ...
        \begin{center}
            ...
            \end{tikzpicture}
        \end{center}
        and thus we get a cartesian natural transformation $\gamma\colon F_p\to F_q\in\Fun(L^{\rhd},C)_1$.
