...
\begin{definition}[Universality] 
    ...
    We say that \emph{$C$ has universal colimits for $K$-shaped diagrams} if for all natural transformations $\alpha\colon p\to q\in\Fun(K^{\rhd},C)_1$ where $q$ is a colimit cone and $\alpha$ is cartesian, $p$ is also a colimit cone.
...
\begin{definition}[Descent] 
    Let $C$ be an \inftycat/ that admits small colimits and pullbacks and let $K$ be a small simplicial set.
    We say that \emph{$C$ has descent for $K$-shaped diagrams} if for all natural transformations $\alpha\colon p\to q\in\Fun(K^{\rhd},C)_1$ where $p,q$ are colimit cones and $\alpha|_K$ is cartesian, $\alpha$ is also cartesian.
