...
One can show that all objects of a locally presentable category must be compact, meaning $\kappa$-compact for some regular cardinal $\kappa$ (see \cite[Remark 1.30 (1)]{access_and_pres_cats}).
However all compact spaces of $\Top$ are discrete spaces (see \cite[Examples 1.14 (6)]{access_and_pres_cats}).
