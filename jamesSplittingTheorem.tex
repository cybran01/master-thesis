...
\begin{definition}
    ...
    \begin{itemize}
        ...
        Note that if $X$ is pointed then $\Sigma X$ is canonically pointed by the essentially unique map $*\to X\to\Sigma X$ since both canonical maps $X\to *\to \Sigma X$ are equivalent.
