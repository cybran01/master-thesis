...
\begin{corollary}[Fundamental James Splitting, iterated]
    ...
    \begin{equation*}
        \Sigma\Omega\Sigma X \cong\bigvee\limits_{1\leq i\leq n}\Sigma X^{\wedge i}\vee\left(X^{\wedge n}\wedge\Sigma\Omega\Sigma X\right)
    \end{equation*}
...
\begin{definition}
    ...
    \begin{equation*}
        c_X^n\colon\bigvee\limits_{1\leq i\leq n}\Sigma X^{\wedge i}\to\bigvee\limits_{1\leq i\leq n}\Sigma X^{\wedge i}\vee\left(X^{\wedge n}\wedge\Sigma\Omega\Sigma X\right)\xrightarrow{\cong}\Sigma\Omega\Sigma X
    \end{equation*}
    induce a map
    \begin{equation*}
...
\end{definition}
Our goal now is to prove that this map is an equivalence whenever $X$ is a $0$-connected pointed object. %TODO define k-connected objects, perhaps at definition of truncation
...
The main idea is to show that $X^{\wedge n}\wedge\Sigma\Omega\Sigma X$ is $n$-connected and thus vanishes as $n\to\infty$.
