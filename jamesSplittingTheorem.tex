...
\begin{prop}[Blakers-Massay Theorem]\label{prop:blakersMassay}
    ...
    \begin{reference}
        \cite[Corollary 4.3.1]{gen_blakers_massey}, but this can also be proven by a reduction to topoi of the form $\Fun(A,\spaces)$ similar to \cref{rem:genTopoiComparisonMapEq}.
    \end{reference}
\end{prop}
