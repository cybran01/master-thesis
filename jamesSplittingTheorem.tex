...
\begin{remark}\label{rmk:mapNotProj}
    ...
    It is not sufficient to choose the map $\alpha$ such that the squares of the cube commute, since the higher simplices must also be compatible (our map $\alpha$ fulfills this by construction since it is a universal map).
...
\begin{lemma}\label{lem:allSqArePo}
    ...
    \begin{center} %TODO maybe also work with \Circled{}
        \begin{tikzcd} [sep = 4em]
