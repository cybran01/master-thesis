...
\begin{corollary}\label{cor:connEst} %TODO perhaps cite Proposition 4.12 splittings
...
\begin{prop}[Epi/Mono Factorization]\label{prop:factorConnTrunc}
    ...
    \begin{proof} 
        ...
        By universality we thus only need to show that the projection $E\times_YU_n\to U_n$ is an equivalence for all $n\geq 0$.
