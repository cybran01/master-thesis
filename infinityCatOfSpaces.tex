...
\begin{prop}[Quillen Equivalence of the Model Structure on $\Top$ and $\sSet$]
    ...
    \begin{proof}
        ...
        Thus the statement is reduced to %TODO cite Kerodon 3.5.4.1 and 3.5.4.2 
    \end{proof}
\end{prop}
%TODO define localization CatLR Definition 7.1.2.
\begin{prop}
    ...
    \begin{proof}
        ...
        Since unit and counit are objectwise weak equivalences, their induced maps $\epsilon:\id\to GF$ and $\eta:FG\to \id$ are objectwise invertible and thus invertible natural transformations, which proves the proposition. %TODO cite proof 
    \end{proof}
\end{prop}
%TODO https://people.math.rochester.edu/faculty/doug/otherpapers/dwyer-kan-3.pdf prop 4.8 proves htpy coh nerve of fibcofib is localization at w.e.
%TODO relation of h(co)lim of mode cat and simpl cat is in Higher Algebra 1.3.4.24
