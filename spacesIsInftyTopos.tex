...
\begin{thm}\label{lem:replaceWithStrictDiagram} %TODO is the statement even true in this generality? https://math.mit.edu/~psh/notes/modcattop.pdf
    ...
    \begin{reference}
        \cite[Proposition 1.3.4.25]{higher_algebra} %TODO Remark 1.3.4.16 HA
    \end{reference}
\end{thm}
