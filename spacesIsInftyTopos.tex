...
\begin{prop} %TODO move this prop to after the explanations
    ...
    \begin{proof}
        ...
        We factor the map $A\to\widehat{B}\to B$ into a h-cofibration followed by a weak equivalence.
        We obtain a diagram 
        \begin{center}
            \begin{tikzcd} [sep = 4em]
            ...
            \end{tikzcd}
        \end{center}
        where the left square is a homotopy pushout as its a pushout along an h-cofibration and the outer square is homotopy pushout by definition, thus by the pasting law the right square is also homotopy pushout. 
        This implies by %HTT
