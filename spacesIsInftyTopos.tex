...
\begin{lemma}\label{lem:htpyLimAndColimAgree}
    ...
    \begin{proof}
        ...
        Since objects are equivalent in $\N(M)[W^{-1}]$ if and only if they are isomorphic in $\ho(\N(M)[W^{-1}])$ (see \cref{rmk:boardmanVogt}), this proves the lemma. %TODO is this really clear that is follows from that?
    \end{proof}
\end{lemma}
