    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = .75 cm]
                ...
                & \M(f_{\overline{A}\overline{C}}) \arrow [>->, rr, crossing over, near start,  "h"] & &[-3.5em] \M(f_{\overline{A}\overline{C}})\cup_{\overline{A}}\M(f_{\overline{A}\overline{B}}) \arrow [dd, "p"] & \\
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                \M(f_{\overline{A}\overline{C}}) \arrow[d] \arrow[r, hook] & \M(f_{\overline{A}\overline{C}})\cup_{\overline{A}}\M(f_{\overline{A}\overline{B}}) \arrow[d] \\
                \M(f_{AC}) \arrow[r, hook] & \M(f_{AC})\cup_A\M(f_{AB}) \\
            \end{tikzcd}
            \begin{tikzcd} [sep = 4em]
                \M(f_{\overline{A}\overline{B}}) \arrow[d] \arrow[r, hook] & \M(f_{\overline{A}\overline{C}})\cup_{\overline{A}}\M(f_{\overline{A}\overline{B}}) \arrow[d] \\
                \M(f_{AB}) \arrow[r, hook] & \M(f_{AC})\cup_A\M(f_{AB}) \\
            \end{tikzcd}
        \end{center}
