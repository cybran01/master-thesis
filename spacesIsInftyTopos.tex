...
\begin{definition} %TODO maybe define also for (J^n,\set{1}\times \partial I^n,*), (I^n,\set{1}\times \partial I^n,*)
...
\begin{lemma}\label{lem:compressionVariation} %TODO proof read!
    ...
    \begin{proof}
        We can pick a map $F\colon I^{n+1}\cong I\times I^n\to I^{n+1}$ such that for all $t_0\in I$, the restriction $F_{t_0}=F|_{\set{t_0}\times I^n}$ is a homeomorphism onto its image $J_{t_0}^n=\set{t_0}\times I^n\cup[t_0,1]\times\partial I^n$ such that $F|_{\set{t_0}\times\partial I^n}(t_0,x)=(1,x)$.
        \begin{center}
            \begin{tikzpicture}[scale = 2, opacity = .7]
                ...
                \draw[->] (1.2,0.75) -- (1.3+1,0.75) node [above,midway]{$F_{t_0}$};
                \node[opacity = 1, align = center] at (1.35,1-\relHeight+0.1) {\small$\set{t_0}\times I$};
        ...
        Since the image of the latter is contained in $A$, by the compression criterion $e|_{J^n}\circ F_0$ and hence $e|_{J^n}$ represent the equivalence class of the constant map.
