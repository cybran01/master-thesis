...
\begin{prop}\label{lem:topDescentPoAlt}
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        are both ordinary pullbacks with both vertical maps quasifibrations, they are already homotopy pullbacks by the fiberwise characterization of homotopy pullbacks. 
    \end{proof}
\end{prop}
