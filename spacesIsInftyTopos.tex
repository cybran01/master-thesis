...
\begin{prop}\label{lem:topDescentPo}
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        where all faces are again equivalent to the corresponding faces of the original cube and the indicated maps are h-cofibrations as they are either pushouts of cofibrations or inclusions into the mapping cylinder. %TODO why does this mean they are cofibs?
