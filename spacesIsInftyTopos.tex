...
\begin{prop}\label{prop:poAlongHCofibIsHtpyPo}
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                A \arrow[>->, r, "h"] \arrow[>->,d] & B \arrow[d]\\
                C' \arrow[>->, r, "h"] \arrow[d, "\textasciitilde"] & D' \arrow[d, "\textasciitilde"] \\
                C \arrow[>->, r, "h"] & D
            \end{tikzcd}
        \end{center}
        by taking pushouts.
...
\begin{prop} %TODO move this prop to after the explanations
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                A \arrow[>->, r, "h"] \arrow[d] & \widehat{B} \arrow[r, "\textasciitilde"] \arrow[d] & B \arrow[d] \\
...
\begin{prop}\label{prop:reductionStepDescent}
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                C^{\prime} \arrow[dd] & \hat{C}\times_CC' \arrow[->>]{l}[swap]{\textasciitilde} \arrow[dd] & A^{\prime} \arrow[l] \arrow[r] \arrow[d, "\textasciitilde"] & B^{\prime} \arrow[d, "\textasciitilde"] \\
                && \overline{A} \arrow [->>,d, "h"] \arrow[r] & \overline{B} \arrow[->>,d, "h"] \\
                C & \hat{C} \arrow[->>]{l}{h}[swap]{\textasciitilde} & A \arrow[>->,l, "h"] \arrow[r] & B 
            \end{tikzcd}
        \end{center}
        where 
        \begin{itemize}
            \item $\overline{A}=A\times_{B}\overline{B}$
            \item $A'\to \overline{A}$ is a weak equivalence since $B'\to\overline{B}$ is one and by the pasting law for homotopy pullbacks as the outer and lower square are homotopy pullback
        \end{itemize}
        Next we factor the map $A'\xtailrightarrow{h}X\xrightarrow{\textasciitilde}\hat{C}\times_CC'$. 
        Note that the diagram 
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                X \arrow[r, "\textasciitilde"] \arrow[d] & C' \arrow[d] \\
                \hat{C} \arrow[->>]{r}{\textasciitilde}[swap]{h} & C \\
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                C^{\prime} \arrow[dd] & X \arrow{l}[swap]{\textasciitilde} \arrow[d, "\textasciitilde"] & A^{\prime} \arrow[>->,l, "h"] \arrow[r] \arrow[d, "\textasciitilde"] & B^{\prime} \arrow[d, "\textasciitilde"] \\
        ...
        By the pasting law we thus have that
        \begin{center}
            \begin{tikzcd} [sep = 4em]
        ...
        Since this square is equivalent %TODO maybe define what that means
        to the square
        \begin{center}
            \begin{tikzcd} [sep = 4em]
...
\begin{lemma}\label{lem:mapOfCylIsQuasiFib} %TODO Cubical homotopy Theory Lemma 5.10.6, TODO prove for open and closed mapping cylinder, TODO prove assertions on pullbacks
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                X \arrow[r, "{x\mapsto (x,t)}"] \arrow[->>,d, "h"] & \M(f) \arrow[r, "\textasciitilde"] \arrow[d] & Y \arrow[->>,d, "h"] \\
                A \arrow[r, "{a\mapsto (a,t)}"] & \M(g) \arrow[r, "\textasciitilde"] & B \\
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                F \arrow[r] \arrow[d] & Y \arrow[r, hook, "\textasciitilde"] \arrow[->>,d, "h"] & \M(f) \arrow[d] \\
                * \arrow[r, "\hat{b}"] & B \arrow[r, hook, "\textasciitilde"] & \M(g) \\
            \end{tikzcd}
        \end{center}
...
\begin{prop}
    ...
    \begin{proof}
        ...
        Then $U_1\cap U_2=A\times [0,1)\cup_A A\times[0,1)\cong A\times (0,2)$ via the ''obvious'' homeomorphism. %TODO explain
        ...
        Then $p^{-1}(U_1)\to U_1$ and $p^{-1}(U_2)\to U_2$ are quasifibrations by \cref{lem:mapOfCylIsQuasiFib} since they are both maps of open mapping cylinders induced by the squares 
        \begin{center}
            \begin{tikzcd} [sep = 4em]
