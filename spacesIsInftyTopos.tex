...
\begin{lemma}\label{lem:mapOfCylIsQuasiFib} %TODO prove assertions on pullbacks
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                X \arrow[r, "{x\mapsto (x,\hat{t})}"] \arrow[->>,d, "h"] & \M(f) \arrow[r, "\sim"] \arrow[d] & Y \arrow[->>,d, "h"] \\
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                F \arrow[r] \arrow[d] & X \arrow[r, "{x\mapsto (x,\hat{t})}"] \arrow[->>,d, "h"] & \M(f) \arrow[d] \\
        ...
        \begin{center}
            \begin{tikzcd} [sep = 4em]
                F \arrow[r] \arrow[d] & Y \arrow[r, "\sim"] \arrow[->>,d, "h"] & \M(f) \arrow[d] \\
...
\begin{prop}\label{lem:topDescentPo}
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        where all faces are again equivalent to the corresponding faces of the original cube and the indicated maps are h-cofibrations as they are either pushouts of h-cofibrations or inclusions into the mapping cylinder (see e.g. \cite[Theorem 2]{note_on_cofibs_1}).
