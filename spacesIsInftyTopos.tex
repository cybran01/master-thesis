...
\begin{lemma}\label{lem:weOfaPairsIsHtpyPb}
    ...
    \begin{proof}
        ...
        \begin{center} 
            \begin{tikzcd} [sep = 4em]
                F_{x_0} \arrow [r, hook] \arrow [->>, d, "h"', "p"] & P_{x_0}X \arrow [->>, d, "h"', "\ev_1"]\\
                A \arrow [r, hook] & X
            \end{tikzcd}
            \begin{tikzcd} [sep = 4em]
                G_{y_0} \arrow [r, hook] \arrow [->>, d, "h"', "q"] & P_{y_0}Y \arrow [->>, d, "h"', "\ev_1"]\\
                B \arrow [r, hook] & Y
            \end{tikzcd}
        \end{center}
        ...
        \begin{center} 
            \begin{tikzcd} [sep = 4em]
                \pi_n(X,A,p(z)) \arrow [r, "\cong"] \arrow [d] & \pi_{n-1}(F_{x_0},z) \arrow [d]\\
                \pi_n(Y,B,f(p(z))) \arrow [r, "\cong"] & \pi_{n-1}(G_{f(x_0)},\alpha(z))
            \end{tikzcd}
        \end{center}
