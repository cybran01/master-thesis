    ...
    \begin{proof}
        ...
        \begin{itemize}
            ...
            \item In the remaining cases either $e(\set{v_{r+1}}\times K)\not\subset Y_1\cap Y_2$ or $e(I_r\times K)\subset Y_1^°\cap Y_2^°$.
                    We pick a deformation retract $F\colon (I_r\times K)\times I\to I_r\times K$ of $J_K^m= I_r\times\partial K\cup\set{v_r}\times K$ (hence $F_1\colon I_r\times K\to J_K^m$) and set $G'_K=G|_{J_K^m}\circ F_1$ and $H'_K=(e|_{I_r\times K}\bullet F)*(H|_{J_K^m}\bullet F_1)$.
