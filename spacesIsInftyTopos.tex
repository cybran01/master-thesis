...
\begin{definition} %TODO maybe define also for (J^n,\set{1}\times I,*)
...
\begin{remark}\label{rmk:inclIntoMappingCylIsHCofib}
    ...
    \begin{center}
        \begin{tikzcd}
            A\times\set{0} \ar[r,"f"] \ar[>->,d, "h"] & B \ar[>->,d, "h"]\\
            A\times I \ar[r] & \M^I(f)
        \end{tikzcd}\;.
    \end{center}
...
\begin{prop}\label{prop:descentForPairs}
    ...
    \begin{proof}
        ...
        Let $\Gamma^m$ denote the collection of cells of dimension $m\in\set{0,\ldots,n}$ of the CW-structure on $I^n$ induced by $\mathcal{D}$ which are not contained in $\partial I^n$, and define $\Gamma^{-1}=\emptyset$.
        ...
        \begin{center}
            \begin{tikzpicture}[scale = .7, opacity = .7]
                ...
                \draw[fill = red, color = red, opacity=0.4] (0+\xshift*2+\step,\size/3*0+\yshift) rectangle (1+\xshift*2+\step,\size/3*1+\yshift);
                \draw[fill = red, color = red, opacity=0.4] (0+\xshift*2+\step,\size/3*1+\yshift) rectangle (1+\xshift*2+\step,\size/3*2+\yshift);
                \draw[fill = red, color = red, opacity=0.4] (0+\xshift*2+\step,\size/3*2+\yshift) rectangle (1+\xshift*2+\step,\size/3*3+\yshift);
                ...
                \draw[fill = black, color = black, opacity=0.4] (0+\xshift*0,0+\yshift) rectangle (\step+\xshift*0,\size+\yshift);
                \draw (0,\size+\yshift) -- (\size,\size+\yshift);
                \draw (0,0+\yshift) -- (0,\size+\yshift);
                \draw (0,0+\yshift) -- (\size,0+\yshift);
                ...
                \draw[fill = black, color = black, opacity=0.4] (0+\xshift*1,0+\yshift) rectangle (\step+\xshift*1,\size+\yshift);
                \draw[color = blue] (0+\xshift*1+\step,\size/3+\yshift) -- (1+\xshift*1+\step,\size/3+\yshift);
                \draw[color = blue] (0+\xshift*1+\step,\size/3*2+\yshift) -- (1+\xshift*1+\step,2*\size/3+\yshift);
                \draw (0+\xshift*1,\size+\yshift) -- (\size+\xshift*1,\size+\yshift);
                \draw (0+\xshift*1,0+\yshift) -- (0+\xshift*1,\size+\yshift);
                ...
                \draw[fill = black, color = black, opacity=0.4] (0+\xshift*2,0+\yshift) rectangle (\step+\xshift*2,\size+\yshift);
                \draw[fill = red, color = red, opacity=0.4] (0+\xshift*2+\step,\size/3*0+\yshift) rectangle (1+\xshift*2+\step,\size/3*1+\yshift);
                \draw[fill = red, color = red, opacity=0.4] (0+\xshift*2+\step,\size/3*1+\yshift) rectangle (1+\xshift*2+\step,\size/3*2+\yshift);
                \draw[fill = red, color = red, opacity=0.4] (0+\xshift*2+\step,\size/3*2+\yshift) rectangle (1+\xshift*2+\step,\size/3*3+\yshift);
                \draw[color = blue] (0+\xshift*2+\step,\size/3*1+\yshift) -- (1+\xshift*2+\step,\size/3*1+\yshift);
        ...
        \begin{itemize}
            ...
            \item if $e(c)\subset Y_1\cap Y_2$ then $e(c)=fg(c)\subset f(X)\cap Y_1\cap Y_2=f(X_1\cap X_2)$ as $f$ is an inclusion and thus $g(c)\subset X_1\cap X_2$
        \end{itemize}
        ...
        We pick a deformation retract $F\colon (I_r\times K)\times I\to I_r\times K$ of $I_r\times\partial K\cup\set{v_r}\times K$ by \cref{rmk:cwInclIsHCofib} and set $G'_K=GF_1$ and $H'_K=eF*HF_1$ which considered as maps $(I_r\times K,\set{v_{r+1}}\times K)\to(X_j,X_1\cap X_2)$ and $(I_r\times K,\set{v_{r+1}}\times K)\times I\to(Y_j,Y_1\cap Y_2)$ respectively fulfill the desired properties.
...
\begin{prop}\label{prop:topDescentPo} %TODO the maps for how to glue the double mapping cylinders are not clear
    ...
    \begin{proof}
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        where top and bottom face are as in \cref{rmk:doubleMappingCylinderAlt} and in particular ordinary pushouts, are equivalent to the starting cube: %TODO  perhaps mention here already that $f$ is a map of excisive triads
    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = .75 cm]
                ...
                & \M(f_{\overline{A}\overline{C}}) \arrow [>->, rr, crossing over,  "h"] & &[-1.5em] \D(f_{\overline{A}\overline{B}},f_{\overline{A}\overline{C}}) \arrow [dd, "p"] & \\
