    ...
    \begin{proof}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 1 cm]
                ...
                P_{k} \arrow [d] \arrow [r] & Y_k \arrow [d, shorten >= -.7em]\\
                X_k \arrow [r] & Y_k\coprod\limits^h X_k\simeq\coprod\limits_{i\in I}^h X_i
            \end{tikzcd}
        \end{center}
        ...
        \begin{center}
            \begin{tikzcd} [sep = 1 cm]
                X_k \arrow [r] \arrow [d] & X_k \arrow [d]\\
                X_k \arrow [r] & X_k\coprod\limits^h Y_k
            \end{tikzcd}
        \end{center}
        is a homotopy pullback square.
