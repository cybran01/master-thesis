...
We will show that this already follows from the fact that $\Top$ has disjoint binary homotopy coproducts and universality for homotopy coproducts.
\begin{definition}
    ...
    \begin{center}
        ...
        \end{tikzcd}
    \end{center}
    (where $\emptyset$ is the initial object and $X\cup^h Y$ the homotopy coproduct) is a homotopy pullback.
\end{definition}
...
\begin{corollary}\label{cor:disjointImpliesDescent}
    ...
    \begin{proof}
        ...
        Note that homotopy coproducts are computed by replacing all objects with cofibrant objects and taking the ordinary pushout, without loss of generality we assume our families of objects to be cofibrant and their coproducts to be ordinary coproducts.
        ...
        \begin{center}
            ...
            \end{tikzcd}
        \end{center}
        and choose cofibrant replacements $\widehat{P_{kj}}$.
        By universality of homotopy coproducts we have that the canonical map $\bigcup\limits_{j\in I}^h \left(\overline{Y_k}\times_{\bigcup\limits_{i\in I}X_i}X_j\right)\simeq\bigcup\limits_{j\in I}\widehat{P_{kj}}\to\overline{Y_k}\times_{\bigcup\limits_{i\in I}Y_i}\left(\bigcup\limits_{j\in I}X_j\right)$ is a weak equivalence.
        So it remains to show that $P_{kj}\simeq\emptyset$ for $k\neq j$ and $X_k\to P_{kk}$ is a weak equivalence.

        Since $X_j\to\bigcup\limits_{i\in I}X_i\to\bigcup\limits_{i\in I}Y_i$ is equal to $X_j\to Y_j\to\bigcup\limits_{i\in I}Y_i$, we can also compute $P_{kj}$ as the successive pullback
...
\begin{corollary}
    ...
    \begin{proof}
        ...
        \Cref{cor:sufficientToProveInModCat} together with \cref{lem:topUniversalPo} and \cref{lem:topUniversalCoproduct} proves that $\spaces$ has universal colimits, and together with \cref{lem:topDescentPo} and \cref{lem:topDescentCoproduct} proves that it has descent.
    \end{proof}
\end{corollary}