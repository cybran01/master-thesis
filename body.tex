...
\begin{document}
    ...
    \subfile{basics.tex}
    \cleardoubleoddstandardpage
    \section{The $\infty$-Category of Spaces $\spaces$} %TODO add stuff: equivalent squares for pb/po, fiberwise characterization of pb and pasting laws
    ...
    \cleardoubleoddstandardpage
    \section{Delooping of Pointed Connected Objects}\label{sec:deloopingPtdConn}
