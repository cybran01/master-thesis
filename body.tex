...
\begin{document}
    ...
    \begin{abstract}\noindent
      ...
      Jacob Lurie attributes this characterization of \inftytops/ to Charles Rezk in \cite[\S 6.1.3]{HTT}, who studied these properties in terms of model topoi in \cite[\S 6]{toposes_and_htpy_toposes}.
      
      \noindent We will achieve this by using the interaction of the Quillen and \Strom/ model structures on $\Top$, in particular the fact that pushouts along cofibrations of the \Strom/ model structure are homotopy pushouts in the Quillen model structure.
