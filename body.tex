...
\begin{document} %TODO fix quotations ´´''
    ...
    \begin{abstract}\noindent
      ...
      As an application of descent, we will prove the May Recognition Theorem in general \inftytops/, which allows one to detect when a pointed connected space is deloopable.
