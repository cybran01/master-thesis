...
\begin{document}
    ...
    \begin{abstract}\noindent
      ...
      As an application of descent, we will prove the May Recognition Theorem from \cite{may2006geometry} for $n=1$ in general \inftytops/, which allows one to detect when a pointed connected object is deloopable.
